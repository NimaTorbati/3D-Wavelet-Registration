function [tform,Rmoving,Rfixed] = imregister1(varargin)
...
%   string. METRIC_CONFIG is an object from the registration.metric
%   package. OPTIMIZER_CONFIG is an object from the registration.optimizer
%   package.
%
%   Notes
%   -------------
...
%   $Revision: 1.1.6.21 $ $Date: 2012/10/08 03:20:29 $
